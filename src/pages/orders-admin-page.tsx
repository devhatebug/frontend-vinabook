                    ...
                    <div className="flex flex-col gap-y-4 break-words">
                        ...
                        <div className="flex items-center gap-x-4">
                            ...
                            >
                                {
                                    statusMap[
                                        currentOrder.status as keyof typeof statusMap
                                    ].label
                                }
                            </Badge>
                        </div>
            ...
            >
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            Bạn có chắc chắn muốn xóa đơn hàng {currentOrder.id}
