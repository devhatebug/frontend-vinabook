              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">
                    Mã đơn hàng: #VB{Math.floor(Math.random() * 10000)}
                  </p>
                  <p className="text-sm text-gray-500">
                ...
                <div>
                  <h3 className="font-medium text-gray-700">Tổng thanh toán</h3>
        ...
        <div className="max-w-md mx-auto">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Vui lòng hoàn tất thanh toán để hoàn thành đơn hàng
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
                <Alert>
                  ...
                  <AlertDescription>
                    ...
                    <p>
                      Chủ tài khoản: <strong>CÔNG TY TNHH VINABOOK</strong>
                    </p>
                    <p>
                    ...
                    <p>
                      Nội dung:{" "}
                      <strong>VB{Math.floor(Math.random() * 10000)}</strong>
                    </p>
                  </AlertDescription>
                </Alert>
                ...
                <div className="text-center text-sm text-gray-500 mt-4">
                  <p>
                    Đây là demo, bạn có thể bấm "Xác nhận đã thanh toán" để tiếp
                    tục
                  </p>
                </div>
              </div>
